...
import cn.dooling.samlazure.config.filter.JWTAuthenticationFilter;
import cn.dooling.samlazure.config.filter.JWTAuthorizationFilter;
import cn.dooling.samlazure.config.saml.SamlAuthenticationFailureHandler;
import cn.dooling.samlazure.config.saml.SamlAuthenticationProvider;
import cn.dooling.samlazure.config.saml.SamlAuthenticationSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.cors()
                ...
                .addFilter(new Saml2WebSsoAuthenticationRequestFilter(new DefaultSaml2AuthenticationRequestContextResolver(relyingPartyRegistrationResolver), new OpenSamlAuthenticationRequestFactory()))
