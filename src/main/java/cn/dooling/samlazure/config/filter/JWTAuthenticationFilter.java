...
import cn.dooling.samlazure.module.user.domain.dto.LoginFormDTO;
    ...
    public JWTAuthenticationFilter(AuthenticationManager authenticationManager, JWTHelper jwtHelper) {
        ...
        setAuthenticationSuccessHandler(new AuthenticationSuccessHandler() {
            ...
            public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
                ServletUtil.write(response, JSONUtil.toJsonStr(new ResponseDTO<>(jwtHelper.getToken(response))), ContentType.JSON.toString());
            }
        });
    }
